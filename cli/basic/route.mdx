...
以上只是简单介绍路由相关API从哪里获取使用，更多的详细API地址请移步[react-router-dom](https://reactrouter.com/en/main)和[history](./api.mdx) 
...
如果你已经阅读了[布局](./layout.mdx)和[资源共享](./remote.mdx#远程页面)章节，或者已经跟着[快速开始](../guide.mdx)教程过了一遍，你会发现，影响我们路由地址的不仅仅是页面本身的目录结构。
